...
describe("resolveVersionEntry", () => {
	...
	it("sha prefix ≥7", () => expect(resolveVersionEntry(versions, "bbbbbbb")?.version).toBe("v2"));
	it("short prefix rejected", () => expect(resolveVersionEntry(versions, "bbb")).toBeUndefined());
