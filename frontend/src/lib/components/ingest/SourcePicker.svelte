...
<div class="mx-auto w-full max-w-[640px]">
	...
	<div class="mb-8 text-center">
		...
		<h2
			class="mt-2 text-2xl font-bold tracking-[0.2em] text-primary drop-shadow-[0_0_20px_rgba(59,130,246,0.4)]"
		>
	...
	{#if !loadingSources && sources.length > 0}
		...
		<h3
			class="mb-3 font-mono text-[10px] font-semibold tracking-[0.14em] uppercase text-muted-foreground"
		>
		...
		<div class="flex flex-col gap-1.5">
			{#each sources as src (src.name)}
				<div
					class="flex items-center gap-2.5 rounded-md bg-muted/20 px-3 py-2 text-sm text-secondary-foreground"
				>
					<span class="shrink-0">
