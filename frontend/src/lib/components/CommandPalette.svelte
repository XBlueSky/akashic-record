...
>
        ...
        {#each searchResults as result (result.id)}
          ...
          >
            <div class="flex w-full items-center gap-2">
              <span
                class="inline-flex shrink-0 rounded px-1.5 py-0.5 text-[10px] font-bold uppercase tracking-wider {layerColor(result.layer)}"
              >
                {result.layer}
              </span>
              <span class="inline-flex shrink-0 rounded bg-white/5 border border-white/10 px-1.5 py-0.5 text-[10px] font-semibold uppercase tracking-wider text-slate-400">
                {result.type}
              </span>
  ...
  <div class="flex items-center justify-between bg-black/20 border-t border-white/5 px-3 py-2 text-xs text-slate-500">
    <div class="flex items-center gap-3">
      <span class="flex items-center gap-1">
        <kbd class="rounded border border-white/10 bg-white/5 px-1.5 py-0.5 font-mono text-[10px] text-slate-400">↑↓</kbd>
        {$t('command.navigate')}
      </span>
      <span class="flex items-center gap-1">
        <kbd class="rounded border border-white/10 bg-white/5 px-1.5 py-0.5 font-mono text-[10px] text-slate-400">↵</kbd>
    ...
    <span class="flex items-center gap-1">
      <kbd class="rounded border border-white/10 bg-white/5 px-1.5 py-0.5 font-mono text-[10px] text-slate-400">esc</kbd>
      {$t('command.close')}
    </span>
  </div>
</Command.Dialog>
