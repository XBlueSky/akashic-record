          ...
          {#each g.pages as p}
            <li role="treeitem" aria-selected={p.fullKey === currentFullKey}>
              <a
                ...
                class="block rounded px-2 py-1 text-[13px] leading-5 outline-none transition-colors duration-150 focus-visible:ring-2 focus-visible:ring-ring {p.fullKey === currentFullKey
